                                ...
                                <div class="single-products">
                                    <div class="productinfo text-center">
                                       ...
                                       <h5 style="text-decoration: line-through;"> Giá gốc: {{ $item->giakm }}</h5>
                                        <h2>{{$item->DonGia}}<span style="color: #746B6B; font-size: 10px;">VNĐ</span></h2>
                                        <p>{{ $item->TenSP}}</p>
                                    ...
                                    <div class="product-overlay">
                                        <div class="overlay-content">
                                               <img src="{!! asset('admin/img/'.$item->img) !!}" width="200px" height="200px">
                                             <p  style="color: black">{{ $item->chuthich}}</p>
                                            <h2 style="color: black"><span style="color: black ; font-size: 18px">Price: </span>{{$item->DonGia}}<span style="font-size: 10px">VNĐ</span></h2>
