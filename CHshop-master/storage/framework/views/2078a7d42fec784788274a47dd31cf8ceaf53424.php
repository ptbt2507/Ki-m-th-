        ...
        <div class="container">
            <div class="row">
                                ...
                                <div class="single-products">
                                    ...
                                    <div class="product-overlay">
                                        <div class="overlay-content">
                                               <img src="<?php echo asset('admin/img/'.$item->img); ?>" width="200px" height="200px">
                                             <p  style="color: black"><?php echo e($item->chuthich); ?></p>
                                            <h2 style="color: black"><span style="color: black ; font-size: 18px">Price: </span><?php echo e($item->DonGia); ?><span style="font-size: 10px">VNĐ</span></h2>
              ...
              <?php endfor; ?>
                ...
                <div class="col-sm-9 padding-right">
                        <div class="features_items"><!--features_items-->
                            <h2 class="title text-center">Sản Phẩm đưọc mua gần đây </h2>
